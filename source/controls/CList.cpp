...
/////////////////////////////////////
CList::CList( HINSTANCE hInstance, 
					 HWND hParent,
					 int nX, int nY , 
...
CList::CList( HINSTANCE hInstance, HWND hParent ) : CControl( hInstance, hParent )
{
}
...
void CList::create( DWORD ex_style )
{
...
void CList::create( DWORD ex_style, DWORD styles )
{
	m_hWnd = CreateWindowEx( ex_style,
		 "LISTBOX", 
		 "Caption", 
...
string CList::getItem( int index )
{
	char szBuffer[ 255 ];
