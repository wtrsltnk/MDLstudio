...
/////////////////////////////////////
CCombo::CCombo( HINSTANCE hInstance, 
					 HWND hParent,
					 int nX, int nY , 
...
CCombo::CCombo( HINSTANCE hInstance, HWND hParent ) : CControl( hInstance, hParent )
{
}
...
void CCombo::create( DWORD ex_style )
{
...
void CCombo::create( DWORD ex_style, DWORD styles )
{
	m_hWnd = CreateWindowEx( ex_style,
		 "COMBOBOX", 
		 "Caption", 
...
string CCombo::getItem( int index )
{
	char szBuffer[ 255 ];
...
string CCombo::getSelected( void )
{
