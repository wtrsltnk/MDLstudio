...
CBrowseDlg::CBrowseDlg( HINSTANCE hInstance, HWND hWnd )
{
	this->m_hOwner		= hWnd;
...
BOOL CBrowseDlg::DlgProc( HWND hDlg, UINT uMsg, WPARAM wParam, LPARAM lParam )
{
	int nWidth, nHeight;
	...
	case WM_NOTIFY:
		...
		case ID_FILE:
			...
			case LVN_ITEMACTIVATE:
				...
				strcpy(result, strFilePath.c_str());
				strcat(result, strFileName.c_str());
