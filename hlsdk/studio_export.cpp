...
bool StudioModel::BMP_ExportTexture(char *Texname, char *Filename)
{
	byte			*pColorData;
	byte			*pBitData;
	studiohdr_t		*pHdr;
...
bool StudioModel::BMP_WriteTexture(byte *pBitData, byte *pColorData, char *sFilename, mstudiotexture_t *pTexture)
{
	FILE				*fp;
...
bool StudioModel::SMD_ExportSequence(char *Seqname, char *filename)
{
	FILE				*smdfile;
...
==============================================================
*/
void StudioModel::SMD_WriteFrame(FILE *smdfile, int frame, mstudioanim_t *panim, mstudioseqdesc_t *pseqdesc)
{
	int					j,k,kf;
	studiohdr_t			*phdr;
	mstudiobone_t		*pbone;
...
void StudioModel::SMD_WriteNodes(FILE *smd)
{
	int					i;
	studiohdr_t			*phdr;
	mstudiobone_t		*pbone;
...
==============================================================
*/
bool StudioModel::SMD_GenerateReferences(int Bodyindex, char *Refname, char *Filename)
{
...
void StudioModel::SMD_WriteTriangle(FILE *smdfile, mstudiomodel_t *pmodel, mstudiotexture_t *ptexture, short *pA, short *pB, short *pC)
{
	float				s,t;
	studiohdr_t			*phdr;
	byte				*pvertbone;
