...
// All rights reserved.
//////////////////////////////////////////////////////////////////////
void StudioModel::DrawIcosahedron(float x,float y,float z,float size)
{
...
================
*/
void StudioModel::DrawMaterial( int skin, int nWidth, int nHeight )
{
	float				w, h;
	float				x, y;
	studiohdr_t			*hdr;
...
================
*/
void StudioModel::DrawUVMap( int skin, int nWidth, int nHeight )
{}
...
mstudiotexture_t *StudioModel::GetMaterial( char *name )
{
	mstudiotexture_t *pTextures;
